function solve() {
    ...
    switch (command) {
        ...
        case "flight":
            ...
            resultElement.textContent = `Your flight number ${flight} is from ${airports[0]} to ${airports[1]}.`;
            break;
        case "company":
        ...
        case "all":
            ...
            resultElement.textContent = `Mr/Ms, ${name1}, your flight number ${flight1} is from ${airports1[0]} to ${airports1[1]}. Have a nice flight with ${company1}.`;
            break;
        default:
            break;
    }
